...
export const aiOperatorCommands = [
  ...
  'npm run tasks:update',
  'npm run tasks:assign',
  'npm run tasks:claim',
  'npm run tasks:route',
  'npm run tasks:block',
  'npm run tasks:unblock',
  'npm run tasks:complete',
  'npm run tasks:archive',
  'npm run tasks:dependencies',
  'npm run tasks:queue',
  'npm run tasks:report',
  'npm run tasks:validate',
  'npm run memory:entities',
  'npm run memory:entity',
  'npm run memory:facts',
  'npm run memory:add-fact',
  'npm run memory:update-fact',
  'npm run memory:supersede-fact',
  'npm run memory:relationships',
  'npm run memory:add-relationship',
  'npm run memory:conflicts',
  'npm run memory:review-conflict',
  'npm run memory:agent-view',
